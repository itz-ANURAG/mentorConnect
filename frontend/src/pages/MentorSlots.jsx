...
const MentorSlots = () => {
    ...
    return (
        <div className="p-4 bg-gray-100 text-gray-900">
            ...
            {/* Pagination */}
            <Pagination count={Math.ceil(filteredSlots.length / slotsPerPage)} page={currentPage} onChange={handlePageChange} className="mt-4" />
            ...
            <Modal open={bookingModalOpen} onClose={handleCloseBookingModal}>
                <div className="modal-content p-4">
                    ...
                    <div className="flex gap-4 mt-4">
                        ...
                        <Button variant="outlined" color="secondary" onClick={handleCloseBookingModal}>
                            Cancel
                        </Button>
                    </div>
                </div>
