        ...
        const fetchMenteeData = async () => {
            if (role === 'mentee') {
                try {
                    ...
                    setMenteeData({ ...response.data.mentee, bookedSessions: sortedSessions });
                } catch (error) {
        ...
        <>
            ...
            <div className="bg-gray-100 min-h-screen w-full p-6">
                <div className="bg-white rounded-lg shadow-lg max-w-4xl mx-auto p-6">
                    <h2 className="text-2xl font-bold text-gray-800 mb-6 text-center">Registered Sessions</h2>
                    <input
                        type="text"
                        ...
                        {paginatedSessions && paginatedSessions.length > 0 ? (
                            <table className="min-w-full bg-gray-50 border border-gray-200 rounded-lg">
                                <thead className="bg-indigo-500 text-white">
                                    <tr>
                                        <th className="px-6 py-3 text-left text-sm font-semibold uppercase tracking-wider">Mentor Name</th>
                                        <th className="px-6 py-3 text-left text-sm font-semibold uppercase tracking-wider">Mentor Email</th>
                            ...
                            <p className="text-gray-700 text-center">No registered sessions found.</p>
                        )}
                    </div>
